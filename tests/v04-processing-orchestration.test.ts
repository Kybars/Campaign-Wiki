...
beforeEach(() => {
  ...
  mocks.applyExplicitIdentityRelationships.mockImplementation((inventory) => ({ inventory, memberToCanonicalId: new Map(), resolutionKeys: new Map(), reviewPairs: [], fingerprint: "identity" }));
